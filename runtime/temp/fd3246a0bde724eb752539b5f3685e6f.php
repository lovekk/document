<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\wamp\www\document\public/../application/admin\view\monograph\showlist.htm";i:1523945705;s:68:"D:\wamp\www\document\public/../application/admin\view\common\top.htm";i:1523986191;s:69:"D:\wamp\www\document\public/../application/admin\view\common\left.htm";i:1524399328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="专著期刊" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('monograph/add'); ?>'"><i class="fa fa-plus"></i> 专著新增
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">专著标题</th>
                                            <th class="text-center">专著作者</th>
                                            <th class="text-center">专著类型</th>
                                            <th class="text-center" width="10%">关键词</th>
                                            <th class="text-center">专著版本</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('monograph/edit',array('id'=>$vo['id'])); ?>"
                                                   class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#"
                                                   onClick="warning('确实要删除吗', '<?php echo url('monograph/del',array('id'=>$vo['id'])); ?>')"
