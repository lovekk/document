<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\wamp\www\tp5_blog\public/../application/index\view\index\showjournal.html";i:1523979380;s:72:"D:\wamp\www\tp5_blog\public/../application/index\view\common\header.html";i:1523982405;s:71:"D:\wamp\www\tp5_blog\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\tp5_blog\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>期刊列表</title>
...
<div class="overall">
	<div class="left">
		...
		<div class="xnews2">
			<div class="dec">
				<a style="font-size: 20px" target="_blank" href="<?php echo url('index/showJournal',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a>
				<br>
				<span class="writor">
                    作者：<?php echo $vo['author_ch']; ?>|<?php echo $vo['author_en']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    发布时间：<?php echo $vo['datetime']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    期刊名：<?php echo $vo['full_name']; ?>
                </span>
			</div>
		</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
