<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\wamp\www\document\public/../application/index\view\index\showstandard.html";i:1524566279;s:72:"D:\wamp\www\document\public/../application/index\view\common\header.html";i:1523982405;s:71:"D:\wamp\www\document\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\document\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>标准列表</title>
...
<div class="overall">
	<div class="left">
		<?php if(is_array($standardList) || $standardList instanceof \think\Collection): $i = 0; $__LIST__ = $standardList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<div class="xnews2">
			<div class="dec">
				<a style="font-size: 20px" target="_blank" href="<?php echo url('index/showStandard',array('id'=>$vo['id'])); ?>"><?php echo $vo['sta_name']; ?></a>&nbsp;&nbsp;&nbsp;点击量：<?php echo $vo['cnum']; ?>
				<br>
				<span class="writor">
                    发布部门：<?php echo $vo['department']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    申请日期：<?php echo $vo['datetime']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    标准号：<?php echo $vo['number']; ?><br>

					<a style="font-size: 20px" target="_blank" href="<?php echo url('index/outwordE',array('id'=>$vo['id'],'qufen'=>6)); ?>"><input type="button" value="下载" ></a>
