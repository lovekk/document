<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\wamp\www\document\public/../application/index\view\index\showthesis.html";i:1524566054;s:72:"D:\wamp\www\document\public/../application/index\view\common\header.html";i:1525964967;s:71:"D:\wamp\www\document\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\document\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>论文列表</title>
...
<div class="overall">
	<div class="left">
		...
		<div class="xnews2">
			<div class="dec">
				<a style="font-size: 20px" target="_blank" href="<?php echo url('index/showThesis',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a>&nbsp;&nbsp;&nbsp;点击量：<?php echo $vo['cnum']; ?>

				<br>
				<span class="writor">
                    作者：<?php echo $vo['author_ch']; ?>|<?php echo $vo['author_en']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    发布日期：<?php echo $vo['datetime']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    学位授予：<?php echo $vo['location']; ?><br>

					<a style="font-size: 20px" target="_blank" href="<?php echo url('index/outwordC',array('id'=>$vo['id'],'qufen'=>3)); ?>"><input type="button" value="下载" ></a>
