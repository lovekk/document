<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\wamp\www\document\public/../application/admin\view\newspaper\edit.htm";i:1523944962;s:68:"D:\wamp\www\document\public/../application/admin\view\common\top.htm";i:1523986191;s:69:"D:\wamp\www\document\public/../application/admin\view\common\left.htm";i:1524399328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author_ch" placeholder="" name="author_ch"
                                                       type="text" value="<?php echo $newspapers['author_ch']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="author_en"
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author_en" placeholder="" name="author_en"
                                                       type="text" value="<?php echo $newspapers['author_en']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="type"
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="type" placeholder="" name="type"
                                                       type="text" value="<?php echo $newspapers['type']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="paper_name" placeholder="" name="paper_name"
                                                       type="text" value="<?php echo $newspapers['paper_name']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="version" placeholder="" name="version"
                                                       type="text" value="<?php echo $newspapers['version']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="publisher" placeholder="" name="publisher"
                                                       type="text" value="<?php echo $newspapers['publisher']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="datetime" placeholder="" name="datetime"
                                                       type="date" value="<?php echo $newspapers['datetime']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="abstract" class="form-control" id="abstract" rows="10px" ><?php echo $newspapers['abstract']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <textarea name="content" id="content"><?php echo $newspapers['content']; ?></textarea>
                                                </label>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
