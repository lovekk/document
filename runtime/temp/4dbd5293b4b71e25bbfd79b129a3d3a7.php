<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\wamp\www\document\public/../application/index\view\index\oneJournal.html";i:1524632583;s:72:"D:\wamp\www\document\public/../application/index\view\common\header.html";i:1525964967;s:71:"D:\wamp\www\document\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\document\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="overall">
    <div class="left">
        <!--头部-->
        <div class="scrap">
            <h1><?php echo $oneJournal['title']; ?></h1>
            <div class="spread">
                <span class="writor">出版日期：<?php echo $oneJournal['datetime']; ?></span>
                <span class="writor">作者：<?php echo $oneJournal['author_ch']; ?> | <?php echo $oneJournal['author_en']; ?></span>
                <span class="writor" style="color: #aa0000;font-size: 19px">期刊全称：<?php echo $oneJournal['full_name']; ?></span><br><br>

                <span class="writor">期刊类型：<?php echo $oneJournal['type']; ?></span>
                <span class="writor">关键词：<?php echo $oneJournal['con_key']; ?></span>
            </div>
        </div>
        <br>
        <!--摘要-->
        <div class="takeaway">
            ...
            <p class="jjxq">摘要：<?php echo $oneJournal['abstract']; ?></p>
            <span class="btn arr-right"></span>
        </div>
        <!--内容-->
        <div class="substance">
            <?php echo $oneJournal['content']; ?>
        </div>
