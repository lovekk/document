<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\wamp\www\tp5_blog\public/../application/admin\view\patent\edit.htm";i:1523883779;s:68:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\top.htm";i:1475309002;s:69:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\left.htm";i:1523884002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('patentes/showList'); ?>">专利管理</a>
                    </li>
                    <li class="active">专利修改</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">专利修改</span>
                            </div>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            <label for="title"
                                                   class="col-sm-2 control-label no-padding-right">专利标题</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title"
                                                       type="text" value="<?php echo $patent['title']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author_ch" placeholder="" name="author_ch"
                                                       type="text" value="<?php echo $patent['author_ch']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="author_en"
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author_en" placeholder="" name="author_en"
                                                       type="text" value="<?php echo $patent['author_en']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="type"
                                                   class="col-sm-2 control-label no-padding-right">专利类型</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="type" placeholder="" name="type"
                                                       type="text" value="<?php echo $patent['type']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="con_key" placeholder="" name="con_key"
                                                       type="text" value="<?php echo $patent['con_key']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="country" placeholder="" name="country"
                                                       type="text" value="<?php echo $patent['country']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="number"
                                                   class="col-sm-2 control-label no-padding-right">专利号</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="number" placeholder="" name="number"
                                                       type="text" value="<?php echo $patent['number']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="datetime"
                                                   class="col-sm-2 control-label no-padding-right">申请年份</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="datetime" placeholder="" name="datetime"
                                                       type="date" value="<?php echo $patent['datetime']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="abstract" class="form-control" id="abstract" rows="10px" ><?php echo $patent['abstract']; ?></textarea>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="content"
                                                   class="col-sm-2 control-label no-padding-right">专利内容</label>
                                            <div class="col-sm-6">
                                                <label>
                                                    <textarea name="content" id="content"><?php echo $patent['content']; ?></textarea>
                                                </label>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
