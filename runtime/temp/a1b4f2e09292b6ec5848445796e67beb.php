<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"D:\wamp\www\document\public/../application/index\view\index\oneStandard.html";i:1523982314;s:72:"D:\wamp\www\document\public/../application/index\view\common\header.html";i:1523982405;s:71:"D:\wamp\www\document\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\document\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="overall">
    <div class="left">
        <!--头部-->
        <div class="scrap">
            <h1><?php echo $oneStandard['sta_name']; ?></h1>
            <div class="spread">
                <span class="writor">发布日期：<?php echo $oneStandard['datetime']; ?></span>
                <span class="writor">实施日期：<?php echo $oneStandard['datetime_action']; ?></span>
                <span class="writor">发布部门：<?php echo $oneStandard['department']; ?></span><br><br>

                <span class="writor">标准类型：<?php echo $oneStandard['type']; ?></span>
                <span class="writor">标准状态：<?php echo $oneStandard['condition']; ?></span>
                <span class="writor">标准编号：<?php echo $oneStandard['number']; ?></span>
            </div>
        </div>
        <br>
        <!--摘要-->
        <div class="takeaway">
            ...
            <p class="jjxq">摘要：<?php echo $oneStandard['abstract']; ?></p>
            <span class="btn arr-right"></span>
        </div>
        <!--内容-->
        <div class="substance">
            <?php echo $oneStandard['content']; ?>
        </div>
