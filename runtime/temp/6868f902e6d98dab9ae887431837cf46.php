<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\wamp\www\document\public/../application/admin\view\admin\lst.htm";i:1524565584;s:68:"D:\wamp\www\document\public/../application/admin\view\common\top.htm";i:1523986191;s:69:"D:\wamp\www\document\public/../application/admin\view\common\left.htm";i:1524399328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                <button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('admin/add'); ?>'"><i class="fa fa-plus"></i> 添加管理员
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <!--跳转到的方法'admin/edit'  传参array('id'=>$vo['id'])-->
