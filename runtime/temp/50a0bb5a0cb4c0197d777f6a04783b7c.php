<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\wamp\www\tp5_blog\public/../application/index\view\index\showstandard.html";i:1523983109;s:72:"D:\wamp\www\tp5_blog\public/../application/index\view\common\header.html";i:1523982405;s:71:"D:\wamp\www\tp5_blog\public/../application/index\view\common\right.html";i:1523983427;s:70:"D:\wamp\www\tp5_blog\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>标准列表</title>
...
<div class="overall">
	<div class="left">
		...
		<div class="xnews2">
			<div class="dec">
				<a style="font-size: 20px" target="_blank" href="<?php echo url('index/showStandard',array('id'=>$vo['id'])); ?>"><?php echo $vo['sta_name']; ?></a>
				<br>
				<span class="writor">
                    发布部门：<?php echo $vo['department']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    申请日期：<?php echo $vo['datetime']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    标准号：<?php echo $vo['number']; ?>
                </span>
			</div>
		</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
