<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\wamp\www\tp5_blog\public/../application/admin\view\journal\showlist.htm";i:1523879085;s:68:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\top.htm";i:1475309002;s:69:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\left.htm";i:1523880077;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <form class="form-horizontal" role="form" action="" enctype="multipart/form-data"
                ...
                <select name="menu">
                    ...
                    <option value="author_cn">作者</option>
                    <option value="type">类型</option>
                    <option value="con_key">关键词</option>
                    <option value="full_name">期刊</option>
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="新增期刊" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('journal/add'); ?>'"><i class="fa fa-plus"></i> 期刊新增
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">期刊标题</th>
                                            <th class="text-center">期刊作者</th>
                                            <th class="text-center">期刊类型</th>
                                            <th class="text-center" width="10%">关键词</th>
                                            <th class="text-center">期刊全称</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo $vo['con_key']; ?></td>
                                            <td align="center"><?php echo $vo['full_name']; ?></td>
                                            <td align="center"><?php echo $vo['datetime']; ?></td>
                                            <td align="center"><?php echo mb_substr($vo['abstract'],0,30,'utf-8'); ?>...</td>

                                            <td align="center">
                                                <a href="<?php echo url('journal/edit',array('id'=>$vo['id'])); ?>"
                                                   class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#"
                                                   onClick="warning('确实要删除吗', '<?php echo url('journal/del',array('id'=>$vo['id'])); ?>')"
