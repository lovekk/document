<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp\www\document\public/../application/admin\view\thesis\showlist.htm";i:1523883399;s:68:"D:\wamp\www\document\public/../application/admin\view\common\top.htm";i:1523986191;s:69:"D:\wamp\www\document\public/../application/admin\view\common\left.htm";i:1524399328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="学位论文期刊" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('thesis/add'); ?>'"><i class="fa fa-plus"></i> 学位论文新增
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">论文标题</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php echo $vo['location']; ?></td>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('thesis/edit',array('id'=>$vo['id'])); ?>"
                                                   class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#"
                                                   onClick="warning('确实要删除吗', '<?php echo url('thesis/del',array('id'=>$vo['id'])); ?>')"
