<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\wamp\www\tp5_blog\public/../application/admin\view\journal\edit.htm";i:1523874499;s:68:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\top.htm";i:1475309002;s:69:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\left.htm";i:1523880077;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="main-container container-fluid">
    ...
    <ul class="nav sidebar-menu">
        ...
        <a href="<?php echo url('article/lst'); ?>" class="menu-dropdown">
            <i class="menu-icon fa fa-file-text"></i>
            <span class="menu-text">学位论文</span>
            <i class="menu-expand"></i>
        </a>
        </li>
        <li>
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('journal/showList'); ?>">期刊管理</a>
                    </li>
                    <li class="active">期刊修改</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">期刊修改</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data"
                                          method="post">
                                        <input type="hidden" name="id" value="<?php echo $journals['id']; ?>">
                                        <div class="form-group">
                                            <label for="title"
                                                   class="col-sm-2 control-label no-padding-right">期刊标题</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title"
                                                       type="text" value="<?php echo $journals['title']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author_ch" placeholder="" name="author_ch"
                                                       type="text" value="<?php echo $journals['author_ch']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="author_en"
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author_en" placeholder="" name="author_en"
                                                       type="text" value="<?php echo $journals['author_en']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="type"
                                                   class="col-sm-2 control-label no-padding-right">期刊类型</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="type" placeholder="" name="type"
                                                       type="text" value="<?php echo $journals['type']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="con_key" placeholder="" name="con_key"
                                                       type="text" value="<?php echo $journals['con_key']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="full_name"
                                                   class="col-sm-2 control-label no-padding-right">期刊全称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="full_name" placeholder="" name="full_name"
                                                       type="text" value="<?php echo $journals['full_name']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="abstract" class="form-control" id="abstract" rows="10px" ><?php echo $journals['abstract']; ?></textarea>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="content"
                                                   class="col-sm-2 control-label no-padding-right">期刊内容</label>
                                            <div class="col-sm-6">
                                                <label>
                                                    <textarea name="content" id="content"><?php echo $journals['content']; ?></textarea>
                                                </label>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
