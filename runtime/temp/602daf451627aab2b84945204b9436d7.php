<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\wamp\www\document\public/../application/index\view\index\oneNewspaper.html";i:1523982906;s:72:"D:\wamp\www\document\public/../application/index\view\common\header.html";i:1523982405;s:71:"D:\wamp\www\document\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\document\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="overall">
    <div class="left">
        <!--头部-->
        <div class="scrap">
            <h1><?php echo $oneNewspaper['title']; ?></h1>
            <div class="spread" >
                <span class="writor">发布日期：<?php echo $oneNewspaper['datetime']; ?></span>
                <span class="writor">作者：<?php echo $oneNewspaper['author_ch']; ?> | <?php echo $oneNewspaper['author_en']; ?></span>
                <span class="writor">报纸名称：<?php echo $oneNewspaper['paper_name']; ?></span><br><br>

                <span class="writor">类型：<?php echo $oneNewspaper['type']; ?></span>
                <span class="writor">版次：<?php echo $oneNewspaper['version']; ?></span>
                <span class="writor">出版者：<?php echo $oneNewspaper['publisher']; ?></span>
            </div>
        </div>
        <br>
        <!--摘要-->
        <div class="takeaway">
            ...
            <p class="jjxq">正文快照：<?php echo $oneNewspaper['abstract']; ?></p>
            <span class="btn arr-right"></span>
        </div>
        <!--内容-->
        <div class="substance">
            <?php echo $oneNewspaper['content']; ?>
        </div>
