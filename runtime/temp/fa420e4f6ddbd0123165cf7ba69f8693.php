<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\wamp\www\document\public/../application/index\view\index\shownewspaper.html";i:1524566985;s:72:"D:\wamp\www\document\public/../application/index\view\common\header.html";i:1525964967;s:71:"D:\wamp\www\document\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\document\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title>报纸列表</title>
	...
	<div class="left">
		<div class="xnews2" style="float: left;width: 800px;height: 50px;margin-top: 40px">
			...
			<input type="text" id="search" name="search"
				   style="width: 400px;height:40px;border-radius: 5px;font-size: 18px" placeholder="请输入报纸检索关键词">
            </span>
				<select name="menu" style="width: 100px;height:40px;border-radius: 5px;font-size: 16px">
					<option value="title">题名</option>
					<option value="author_ch">作者</option>
					<option value="type">报纸类型</option>
					<option value="datetime">发布日期</option>
					<option value="paper_name">报纸名称</option>
					<option value="abstract">正文快照</option>
...
<div class="overall">
	<div class="left">
		<?php if(is_array($newspaperList) || $newspaperList instanceof \think\Collection): $i = 0; $__LIST__ = $newspaperList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<div class="xnews2">
			<div class="dec">
				<a style="font-size: 20px" target="_blank" href="<?php echo url('index/showNewspaper',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a> &nbsp;&nbsp;&nbsp;点击量：<?php echo $vo['cnum']; ?>
				<br>
				<span class="writor">
                    作者：<?php echo $vo['author_ch']; ?>|<?php echo $vo['author_en']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    发布日期：<?php echo $vo['datetime']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    报纸名称：<?php echo $vo['paper_name']; ?><br>

					<a style="font-size: 20px" target="_blank" href="<?php echo url('index/outwordF',array('id'=>$vo['id'],'qufen'=>6)); ?>"><input type="button" value="下载" ></a>
