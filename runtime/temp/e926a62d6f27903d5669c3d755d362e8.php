<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\wamp\www\tp5_blog\public/../application/admin\view\standard\edit.htm";i:1523943773;s:68:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\top.htm";i:1475309002;s:69:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\left.htm";i:1523944600;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">标准修改</span>
                            </div>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="sta_name" placeholder="" name="sta_name"
                                                       type="text" value="<?php echo $standard['sta_name']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="type" placeholder="" name="type"
                                                       type="text" value="<?php echo $standard['type']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="department" placeholder="" name="department"
                                                       type="text" value="<?php echo $standard['department']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>

                                        <div class="form-group">
                                            <label for="datetime_publish"
                                                   class="col-sm-2 control-label no-padding-right">发布日期</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="datetime_publish" placeholder="" name="datetime_publish"
                                                       type="date" value="<?php echo $standard['datetime_publish']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="datetime_action" placeholder="" name="datetime_action"
                                                       type="date" value="<?php echo $standard['datetime_action']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="number"
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="number" placeholder="" name="number"
                                                       type="text" value="<?php echo $standard['number']; ?>">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <input class="checkbox-slider colored-darkorange" name="condition" id="condition"
                                                           type="checkbox" <?php if($standard['condition'] == 'on'): ?>checked="checked"<?php endif; ?> >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="datetime_abolish" placeholder="" name="datetime_abolish"
                                                       type="date" value="<?php echo $standard['datetime_abolish']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    <textarea name="content" id="content"><?php echo $standard['content']; ?></textarea>
                                                </label>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
