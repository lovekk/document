<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\wamp\www\document\public/../application/admin\view\patent\showlist.htm";i:1523884354;s:68:"D:\wamp\www\document\public/../application/admin\view\common\top.htm";i:1523986191;s:69:"D:\wamp\www\document\public/../application/admin\view\common\left.htm";i:1524399328;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <form class="form-horizontal" role="form" action="" enctype="multipart/form-data"
                ...
                <select name="menu">
                    ...
                    <option value="datetime">申请年份</option>
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="专利期刊" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('patent/add'); ?>'"><i class="fa fa-plus"></i> 专利新增
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%">专利标题</th>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('patent/edit',array('id'=>$vo['id'])); ?>"
                                                   class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="#"
                                                   onClick="warning('确实要删除吗', '<?php echo url('patent/del',array('id'=>$vo['id'])); ?>')"
