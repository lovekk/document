<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"D:\wamp\www\tp5_blog\public/../application/index\view\index\oneMonograph.html";i:1523977428;s:72:"D:\wamp\www\tp5_blog\public/../application/index\view\common\header.html";i:1523979957;s:71:"D:\wamp\www\tp5_blog\public/../application/index\view\common\right.html";i:1475987682;s:70:"D:\wamp\www\tp5_blog\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="nav">
                ...
                <div class="right">
                    ...
                    <a href="<?php echo url('index/index'); ?>">首页</a>
                        ...
                        <a href="<?php echo url('index/showMonograph'); ?>" >专利</a>
...
<div class="overall">
    <div class="left">
        <!--头部-->
        <div class="scrap">
            <h1><?php echo $oneMono['title']; ?></h1>
            <div class="spread">
                <span class="writor">出版时间：<?php echo $oneMono['datetime']; ?></span>
                <span class="writor">作者：<?php echo $oneMono['author_ch']; ?> | <?php echo $oneMono['author_en']; ?></span>
                <span class="writor">专著版本：<?php echo $oneMono['version']; ?></span><br><br>

                <span class="writor">类型：<?php echo $oneMono['type']; ?></span>
                <span class="writor">出版：<?php echo $oneMono['publisher']; ?></span>
            </div>
        </div>
        <br>
        <!--摘要-->
        <div class="takeaway">
            ...
            <p class="jjxq">摘要：<?php echo $oneMono['abstract']; ?></p>
            <span class="btn arr-right"></span>
        </div>
        <!--内容-->
        <div class="substance">
            <?php echo $oneMono['content']; ?>
        </div>
