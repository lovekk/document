<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"D:\wamp\www\tp5_blog\public/../application/index\view\index\showmonograph.html";i:1523971073;s:72:"D:\wamp\www\tp5_blog\public/../application/index\view\common\header.html";i:1523982405;s:71:"D:\wamp\www\tp5_blog\public/../application/index\view\common\right.html";i:1523983835;s:70:"D:\wamp\www\tp5_blog\public/../application/index\view\common\foot.html";i:1523946266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>专著列表</title>
...
<div class="overall">
    <div class="left">
        ...
        <div class="xnews2">
            <div class="dec">
                <a style="font-size: 20px" target="_blank" href="<?php echo url('index/showMonograph',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a>
                <br>
                <span class="writor">
                    作者：<?php echo $vo['author_ch']; ?>|<?php echo $vo['author_en']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    发布时间：<?php echo $vo['datetime']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    出版：<?php echo $vo['publisher']; ?>
                </span>
            </div>
        </div>
        <?php endforeach; endif; else: echo "" ;endif; ?>
