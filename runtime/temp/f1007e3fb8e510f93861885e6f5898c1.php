<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\wamp\www\tp5_blog\public/../application/admin\view\patent\add.htm";i:1523884106;s:68:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\top.htm";i:1475309002;s:69:"D:\wamp\www\tp5_blog\public/../application/admin\view\common\left.htm";i:1523884002;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('patent/showList'); ?>">专利管理</a>
                    </li>
                    <li class="active">专利新增</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">专利新增</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            <label for="author_ch"
                                                   class="col-sm-2 control-label no-padding-right">申请人(中文)</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="author_en"
                                                   class="col-sm-2 control-label no-padding-right">申请人(英文)</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="country"
                                                   class="col-sm-2 control-label no-padding-right">国别</label>
                                            <div class="col-sm-6">
